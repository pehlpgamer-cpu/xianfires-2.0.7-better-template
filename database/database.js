...
const sql_env = () => {
  if (process.env.ENV === "development") {
    return new Sequelize(development.database, development.username, development.password, {
      host: development.host,
      dialect: development.dialect,
    });
  } else if (process.env.ENV === "production") {
    return new Sequelize(production.database, production.username, production.password, {
