...
async function ensureDatabaseExists() {
  ...
  switch (process.env.ENV) {
    case "development":
      tempDb = new Sequelize("mysql", development.username, development.password, {
      ...
      break;
    case "production":
      tempDb = new Sequelize("mysql", production.username, production.password, {
  ...
  try {
    ...
    const quotedDatabaseName = sequelize.getQueryInterface().quoteIdentifier(databaseName);
